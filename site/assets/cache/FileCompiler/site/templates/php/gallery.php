...
<!-- Photoswipe -->
    ...
    <?php
    echo "<section class='gallery demo-gallery'>";
    foreach($page->gallery as $image){
        // echo "<a class='pslink' data-size='".$image->width."x".$image->height."'>";
        echo "<a href='" . $image->url . "' data-size='".$image->width."x".$image->height."'>";
        echo "<img src='" . $image->url . "'/>";
        // echo "<figure>".$image->description."</figure>";
...
<script>
    ...
    // openPhotoSwipe();
    document.getElementByClass('pslink').onclick = openPhotoSwipe;
